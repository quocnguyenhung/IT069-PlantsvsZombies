...
public class GamePanel extends JLayeredPane{
    ...
    private static Timer zombieProducer, zombieProducer2;
    ...
    public void setSunScore(int sunScore) {
        ...
        sunScoreboard.setLocation(42, 79);
    }
    ...
    private void importImg() {
        ...
        cherryBomb = new BufferedImage[24];
        ...
        for (int i = 0; i < 45; i++) {
            ...
            if (c.assignedPlant != null) {
                ...
                if (p instanceof CherryBomb) {
                    ...
                    g.drawImage(cherryBomb[p.getCountlife()], 5 + (i % 9) * 100, 70 + (i / 9) * 120, 170, 170, null);
                }
            }
        }
    ...
    public static void setProgress(int num) {
        ...
        if (progress >= 70) {
            if (progress == 70) LevelData.zombieSpeed +=1;} 
        if (progress >= 110) {
            if (progress == 110) LevelData.zombieSpeed +=1;
        }
    ...
    // public void setIsRunning(boolean t){
    //     this.isRunning = t;
    // }
    ...
    //         advancerTimer.start();
    //         sunProducer.start();
    //         if (zomcount<16) zombieProducer.start();
    //         else zombieProducer2.start();
    //     }
    // }
    ...
    freezePeashooterImage = null;
    sunflowerImage = null;
    peaImage = null;
    freezePeaImage = null;
    sprite_cherrybomb = null;
    ...
    sunProducer = null;
    zombieProducer = null; 
    zombieProducer2  = null;
    sunScoreboard = null;
    gw = null;
    keyBoardInput = null;
    bar = null;
    activePlantingBrush = null;
    }
